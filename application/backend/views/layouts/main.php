...
<body class="fixed-header fixed-ribbon <?= Yii::$app->request->cookies->getValue('backend_menu', 'normal') ?>">
    ...
    \yii\bootstrap5\Modal::begin(
        [
            ...
            'title' => Yii::t('app', 'Are you sure you want to delete this object?'),
        ]
    )
    ?>
    ...
    \yii\bootstrap5\Modal::begin(
        [
            ...
            'title' => Yii::t('app', 'Mass publish/unpublish items'),
        ]
    )
    ?>
    ...
    \yii\bootstrap5\Modal::begin(
        [
            ...
            'title' => Yii::t('app', 'Batch items movements'),
        ]
    )
    ?>
    <div class="alert alert-info">
    ...
    \yii\bootstrap5\Modal::begin(
        [
            ...
            'title' => Yii::t('app', 'Are you sure you want to delete a selected category?'),
        ]
    )
    ?>
