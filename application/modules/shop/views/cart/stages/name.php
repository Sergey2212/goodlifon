...
<div class="col-md-6 col-md-offset-3">
    <div class="row">
        ...
        <?= $form->field($customer, 'phone')->widget(\yii\widgets\MaskedInput::className(), [
...
$js = <<<JS
    ...
    $('.btn-primary').on('click mousemove', function (event) {

    if(($('#customer-email').val() == '') && ($('#customer-phone').val() == '')){
        Swal.fire({
            title: "Необходимо заполнить «Email» или «Телефон».",
            type: "error",
