...
use app\modules\shop\models\ProductOptionSearch;
...
class BackendProductController extends BackendController
{
    ...
    public function actionIndex()
    {
        ...
        if (null !== $catId = Yii::$app->request->get('parent_id')) {
            $dataProvider->query->leftJoin(
                BaseObject::getForClass(Product::className())->categories_table_name . ' cp',
    ...
    public function actionDelete($id)
    {
        ...
        if (!$model->delete()) {
            ...
            Yii::$app->session->setFlash('info', Yii::t('app', 'BaseObject has been removed'));
        }
