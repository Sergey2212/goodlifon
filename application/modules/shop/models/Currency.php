...
class Currency extends \yii\db\ActiveRecord
{
    ...
    public function format($price)
    {
        if ($this->intl_formatting === 1) {
            ...
            return $this->getFormatter()->asInteger($price);
        } else {
            //$number_value = $this->getFormatter()->asDecimal($price); цекна с двумя нулями
            $number_value = $this->getFormatter()->asInteger($price);
